...
set psu_clock_init_data {
    ...
    mask_write 0XFD1A0074 0x013F3F07 0x01012B00
    ...
    mask_write 0XFD1A007C 0x013F3F07 0x01012800
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00341008
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180070 0x000000FE 0x00000020
    ...
    mask_write 0XFF180074 0x000000FE 0x00000020
    ...
    mask_write 0XFF180204 0x7BFFFFFF 0x60000000
    ...
    mask_write 0XFF180208 0xFFFFE0CF 0xFC002046
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x007FE000
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x0003F034
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF5E0230 0x0000000C 0x00000000
		# : QSPI
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
