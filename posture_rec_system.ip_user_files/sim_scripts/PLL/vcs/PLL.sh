...
#
# Generated by Vivado on Wed Aug 15 17:32:52 +0800 2018
...
# Script info
echo -e "PLL.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SDx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SDx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/SDx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../posture_rec_system.srcs/sources_1/ip/PLL/PLL_clk_wiz.v" \
    "$ref_dir/../../../../posture_rec_system.srcs/sources_1/ip/PLL/PLL.v" \
  2>&1 | tee -a vlogan.log
